...
/**
 * Delete a session (cleanup on tab close)
 * Uses fetch with keepalive for reliable cleanup even when tab is closing
 */
export function deleteSession(sessionId: string): void {
  try {
    // Use fetch with keepalive flag - allows request to complete even after page unload
